...
TOOL_CONFIGS = {
    ...
    "max_memory_usage": 128 * 1024,  # 128GB total
    "cleanup_threshold": 64 * 1024,  # 64GB
    "aggressive_cleanup_threshold": 32 * 1024,  # 32GB
    "force_cleanup_threshold": 96 * 1024,  # 96GB
}
...
class PythonSandbox:
    ...
    async def execute_code(self, code: str, input: str) -> str:
            ...
            try:
                ...
                try:
                    stdout, stderr = await asyncio.wait_for(
                        process.communicate(input=repr(input.strip()).encode()),
